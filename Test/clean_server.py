...
# ==================================================================================
# MODIFIED: This is the only function that needs to change.
# It now uses a secure, auto-deleting temporary file.
# ==================================================================================
def transcription_worker(audio_buffer, task_id):
    """
    Saves audio to a temporary file that is automatically deleted,
    then runs the whisper-cli subprocess.
    """
    if not audio_buffer:
        return
    ...
    try:
        # Create a temporary file that is automatically deleted when the 'with' block is exited.
        # delete=True is the default and ensures cleanup.
        # suffix=".wav" helps whisper-cli identify the file type correctly.
        with tempfile.NamedTemporaryFile(suffix=".wav", delete=True) as tmpfile:
            wav_path = tmpfile.name
            
            # Write the audio data to this temporary file
            ...
            # The file is now written. At this point, whisper-cli can use it.
        ...
        # <<<--- As soon as this 'with' block ends, tmpfile is automatically deleted from your storage.
...
# All the other functions (transcribe_audio_task, audio_handler, main)
# remain exactly the same as the previous version. I am omitting them here for brevity,
# you only need to replace the transcription_worker function.
